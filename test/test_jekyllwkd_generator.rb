...
class JekyllWKD::TestGenerator < Minitest::Test
  def setup
  ...
  def test_generating_a_policy
    pol = @site.in_dest_dir JekyllWKD::PGP_PATH, "example.com/policy"
  ...
  def test_exporting_keys
    ...
    keys.each do |k|
      key = @site.in_dest_dir JekyllWKD::PGP_PATH, "example.com/hu", k
